...
function displaySection(link, section) {
    ...
    lnk.onclick = (event) => {
        ...
        if (mq.matches) {
            ...
            } else if (section == "certifications-section") {
        ...
        // Load content dynamically for certifications and social media sections
        if (section === "certifications-section" || section === "social-media-section") {
            fetch(`${section}.html`)
                .then(response => response.text())
                .then(data => {
                    let wrapper = document.querySelector(`#${section} > div`);
...
displaySection("certifications", "certifications-section");
displaySection("social-media", "social-media-section");
